                            ...
                            <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" style="text-align: center; border: 1px solid black;padding: 20px;">
                                    ...
                                    <tr>
                                        <td colspan="2" style="border: 1px solid black; padding: 5px;">AWB : {{ $order->awb_number }}</td>
                                    ...
                                    <tr>
                                        <td colspan="2" style="border: 1px solid black; padding: 5px;">Pickup Code : {{ trim($order->warehouse->zip_code ?? '') }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="4" style="text-align: center; border: 1px solid black;">
                                            <h1 style="margin: 5px 0;">{{ $order->order_prefix }}</h1>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center; border: 1px solid black;">INR {{ $order->total_amount }}</td>
                                        <td style="text-align: center; border: 1px solid black;">
                                            <p>Destination Pincode:</p>
                                            <p >{{ trim($order->customerAddress->zip_code ?? '') }}</p>
                                        </td>
                                    </tr>
