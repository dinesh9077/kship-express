...
@section('title',config('setting.company_name').' - Create Warehouse')
...
<div class="content-page">
    <div class="content">
        <form id="warehouseForm" method="post" class="customer_form" action="{{ route('warehouse.store') }}" enctype="multipart/form-data"> 
