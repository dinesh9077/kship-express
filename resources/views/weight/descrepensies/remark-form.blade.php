    ...
    <div class="content">
        <div class="container-fluid mt-3">
            <div class="chat-container">
				...
				<form id="remarkForm" action="{{ route('weight.remark.store') }}" method="POST" enctype="multipart/form-data" class="mt-3">
				@csrf
					<input type="hidden" name="order_id" value="{{ $order->id }}">   
					<div class="chat-input">
						<input type="text" name="remark" id="remarkInput" style="height: 49px;" placeholder="Type your remark..." required>
						<input type="file" id="imageUpload" name="images[]" style="height: 49px;" accept="image/*" multiple onchange="previewImages()">
