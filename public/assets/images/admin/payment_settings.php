                ...
                <form method="post" action="<?php echo base_url('admin/payment/update') ?>" role="form" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title d-block">Paypal <span class="pull-right"><input type="checkbox" name="paypal_payment" value="1" <?php if ($settings->paypal_payment == 1) {
                                                                                                                                                                echo 'checked';
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title d-block">Stripe <span class="pull-right"><input type="checkbox" name="stripe_payment" value="1" <?php if ($settings->stripe_payment == 1) {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            } ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span></h3>
                                </div>
                        ...
                        <?php if (settings()->rpa_enable == 1) : ?>
                            <div class="col-sm-6">
                                <div class="box">
                                    <div class="box-header with-border">
                                        <h3 class="box-title d-block">Razorpay <span class="pull-right"><input type="checkbox" name="razorpay_payment" value="1" <?php if ($settings->razorpay_payment == 1) {
                                                                                                                                                                        echo 'checked';
                                                                                                                                                                    } ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span></h3>
                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title d-block">Paystack <span class="pull-right"><input type="checkbox" name="paystack_payment" value="1" <?php if ($settings->paystack_payment == 1) {
                                                                                                                                                                    echo 'checked';
                                                                                                                                                                } ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span></h3>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title d-block">Cashfree Payment<span class="pull-right"><input type="checkbox" name="cashfree_payment" value="1" <?php if ($settings->cashfree_payment == 1) {
                                                                                                                                                                        echo 'checked';
                                                                                                                                                                    } ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span></h3>
                                </div>
                                ...
                                <div class="box-body">
                                    <div class="form-group mt-20">
                                        <label class="col-sm-4 control-label" for="example-input-normal">Cashfree Mode </label>
                                        <div class="col-sm-12">
                                            <select class="form-control" name="cashfree_mode" id="cashfree_mode">
                                                <option value=""><?php echo trans('select') ?></option>
                                                <option value="sandbox" <?php echo ($settings->cashfree_mode == 'sandbox') ? 'selected' : ''; ?>>Sandbox</option>
                                                <option value="live" <?php echo ($settings->cashfree_mode == 'live') ? 'selected' : ''; ?>>Live</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group mt-20">
                                        <label class="col-sm-6 control-label" for="example-input-normal">Cashfree APP ID </label>
                                        <div class="col-sm-12">
                                            <input type="text" name="cashfree_app_id" value="<?php echo html_escape($settings->cashfree_app_id); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group mt-20">
                                        <label class="col-sm-6 control-label" for="example-input-normal">Cashfree Secret Key </label>
                                        <div class="col-sm-12">
                                            <input type="text" name="cashfree_secret_key" value="<?php echo html_escape($settings->cashfree_secret_key); ?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
