									...
									<div class="row spce-bt align-items-end">
										...
										<div class="col-xl-3 mt-10">
											...
											<select class="form-control single_select" name="bank_id" required>
												...
												<?php foreach ($banking as $key => $bank) : ?>

													<?php if ($bank->account_type == "Bank") : ?>
														<optgroup label="Bank">
															<option value="<?php echo html_escape($bank->id); ?>" <?php if (isset($_GET['bank_id']) && $_GET['bank_id'] == $bank->id) {
																														echo  'selected';
																													} else {
																														if ($key == 0) {
																															echo 'selected';
													...
													<?php endif; ?>
													<?php if ($bank->account_type == "Cash In Hand") : ?>
													...
													<?php endif; ?>
													<?php if ($bank->account_type == "Credit Card") : ?>
