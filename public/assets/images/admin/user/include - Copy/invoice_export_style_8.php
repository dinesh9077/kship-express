...
<div class="card-body p-0">
    ...
    <div class="row align-items-start" style="justify-content: space-between; background: <?php echo html_escape($color) ?>; color: #fff;">
        ...
        <div class="col-4 py-4 pl-30 pr-30" style="width: 40%; float: left;">
            ...
            <?php else: ?>
				...
				<p class="mt-0 mb-0" style="font-size:12px"><?php echo trans('business').' '.trans('no') ?>: <?php echo html_escape($cus_number) ?></p>
				<?php endif ?> 
				<?php endif ?>
				<?php endif ?>
            <?php endif ?>
    ...
    <div class="row p-0 table_area" style="margin-top: 0px">
        <div class="col-12 table-responsive">
                ...
                <tbody>
					...
					<tr class="inv-pl30">
					 ...
					 <tr class="inv-pl30" style="border-top: 3px solid  #dfdede">
                        ...
                        <td class="text-right" style="font-size: 12px; padding: 5px 20px; text-align: right"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo number_format($sub_total-$sub_total * ($discount / 100), 2) ?></span></td>
					</tr>
                    <?php else: ?>
                    <tr class="inv-pl30" style="border-top: 3px solid  #dfdede">
                        <td></td>
			...
			<p class="p-10" style="font-size: 12px"><img class="qr_code_sm ml-30" src="<?php echo base_url($pay_qrcode) ?>" alt="QR Code" style="background: transparent"></p>
            <?php endif; ?>
		</div>
	</div>
