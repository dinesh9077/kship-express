...
<div class="card-body p-0">
    ...
    <div class="flex-parent-between inv6-header align-items-start">
        <div class="inv6">
            <?php if (empty($logo)): ?>
        ...
        <div class="inv6">
            <h1 class="mb-1 text-right" style="font-weight: 500; text-transform: uppercase"><?php echo html_escape($title) ?></h1>
            <p class="text-left"><?php echo html_escape($summary) ?></p>
            <table class="tables" style="float: right; width: 100%">
                <tr>
                    <td style="text-align: right; font-size: 12px;"><b class="mr-10"><strong><?php if(isset($page) && $page == 'Invoice'){echo trans('invoice-number');}else if($page == 'Estimate'){echo trans('estimate-number');}else if($page == 'Delivery'){echo 'Challan Number';}else{echo trans('bill-number');} ?>:</b></strong></td>
                    <td class="text-left" colspan="1"><?php echo html_escape($number) ?></td>
				</tr>
                
                <?php if (!empty($poso_number)): ?>
                <tr>
                    <td style="text-align: right; font-size: 12px;"><b class="mr-10"><strong><?php echo trans('p.o.s.o.-number') ?>:</strong></b></td>
                    <td class="text-left" colspan="1"><?php echo html_escape($poso_number) ?></td>
				</tr>
                <?php endif ?>
                
                <tr>
                    <td style="text-align: right; font-size: 12px;"><b class="mr-10"><strong><?php if(isset($page) && $page == 'Invoice'){echo trans('invoice-date');}else if(isset($page) && $page == 'Delivery'){echo 'Delivery Date';}else{echo trans('date');} ?>:</b></strong></td>
				...
				<tr>
					<td style="text-align: right; font-size: 12px;"><b class="mr-10"><strong><?php echo trans('due-date') ?>:</strong></b></td>
					<td class="text-left">
				...
				<tr>
					<td class="text-right">
					    <b class="mr-10"><strong><?php echo trans('expires-on') ?>:</strong></b>
					</td>
					<td class="text-left">
    ...
    <div class="flex-parent-between invtem_top_2" style="background: <?php echo html_escape($color) ?>; color: #fff;">
        ...
        <div class="col-5 text-left">
            ...
            <?php if (isset($page) && $page == 'Bill'): ?>
			    <p style="font-weight: 400; text-transform: uppercase; color: #fff; margin: 0"><?php echo trans('purchase-from') ?></p>
            <?php else: ?>
			    <p style="font-weight: 400; text-transform: uppercase; color: #fff; margin: 0"><?php echo trans('bill-to') ?></p>
            <?php endif ?>
			...
			<p class="mb-1">
				...
				<p class="mt-0 mb-0"><?php echo trans('business').' '.trans('no') ?>: <?php echo html_escape($cus_number) ?></p>
				<?php endif ?> 
				<?php endif ?>
				<?php endif ?>
			</p>
    ...
    <div class="row p-0 table_area">
        <div class="col-12 table-responsive">
            <table class="table">
                <thead class="pre_head2"  style="background: <?php echo html_escape($color) ?>0f">
                    <tr class="pre_head_tr2">
                        <th class="border-0" style="color: <?php echo html_escape($color) ?>;"><?php echo trans('items') ?></th>
                        <th class="border-0 text-center" style="color: <?php echo html_escape($color) ?>;">HSN/SAC Code</th>
                        <th class="border-0 text-right" style="color: <?php echo html_escape($color) ?>;"><?php echo trans('rate') ?></th>
                        <th class="border-0 text-center" style="color: <?php echo html_escape($color) ?>;"><?php echo trans('quantity') ?></th>
                        <th class="border-0 text-center" style="color: <?php echo html_escape($color) ?>;">Unit</th>
                        <th class="border-0 text-right" style="color: <?php echo html_escape($color) ?>;"><?php echo trans('amount') ?></th>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <?php for ($i=0; $i < $total_items; $i++) { ?>
                                <tr>
                                    ...
                                    <?php if (is_numeric($product_id)) {
                                        echo helper_get_product($product_id)->name.'<br> <p>'. nl2br(helper_get_product($product_id)->details).'</p>';
                                    } else {
                    ...
                    <?php else: ?>
                        ...
                        <?php else: ?>
                            <?php foreach ($items as $item): ?>
                                <tr>
                                    <td width="30%">
                                       <p style="font-weight: bold; margin: 0"> <?php echo html_escape($item->item_name) ?> </p>
