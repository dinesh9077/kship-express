        ...
        <div class="col-12 table-responsive p-0">
            <table class="table m-0" style="border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-left: 0; border-right: 0">
						...
						<?php if($this->business->invoice_tax == 1):?>
						    <?php if (!empty($taxes)): ?>
            					<?php foreach ($taxes as $tax): ?>
                					<?php if ($tax != 0): ?>
                				        <th style="font-weight: bold; text-align: center; padding: 5px 10px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse;"><?php echo $tax->tax_type; ?> %</th>
                				        <th style="font-weight: bold; text-align: center; padding: 5px 10px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse;"><?php echo $tax->tax_type; ?> Amount</th>
                					<?php endif ?>
            					<?php endforeach ?>
            				<?php else: ?>
                ...
                <tbody>
					...
					<tr>
						<td colspan="10" class="text-center"><?php echo trans('empty-items') ?></td>
					</tr>
					...
					<tr class="inv">
						...
						<?php if($this->business->invoice_tax == 1):?>
    							...
    							<?php 
    							    ...
    							    if(!empty($item->taxs))
    								{
    									...
    									{   
    							?>
										<td style="border-top: 0; text-align: center;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse;"> <?php echo $taxs[$key]; ?> </td>
										<td style="border-top: 0; text-align: center;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse;"> <?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo decimal_format($taxvals[$key]); ?> </td>	
    							<?php
    									}
    								}
    								else
						...
						<td style="border-top: 0; text-align: right; padding-right:20px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-right: 0">
						    <p class="m-0">
						       <?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?> <?php echo decimal_format($item->total, 2) ?>
						    </p>
						 </td>
					</tr>
					<?php 
					...
					<?php if(count($taxes) >= 2) {?>
						...
						<td style="border-top: 0; padding: 5px 20px; text-align: right; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-right: 0"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} echo decimal_format($total_tax); ?></span></td>
					</tr>
                    <?php endif ?> 
					...
					<tr class="inv">
						...
						<td style="border-top: 0; text-align: center;"></td> 
						<?php } ?>
                        <td colspan="2" class="text-right" style="border-top: 3px solid #dfdede; padding: 5px 12px; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-bottom: 1px solid transparent"><strong><?php echo trans('amount-due') ?>:</strong></td>
