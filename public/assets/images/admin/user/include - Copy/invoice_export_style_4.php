    ...
    <div class="flex-parent-between bill_area align-items-center" style="width: 100%">
     ...
     <div class="row p-0 table_area">
        <div class="col-12 table-responsive">
            ...
            <div class="p-30" style="font-family: georgia">
                <p style="font-size: 13px"><strong>Notes / Terms</strong></p>
			...
			<h6 class="pl-30" style="color: black; font-size: 13px">Scan-QR to Pay</h6>
			<p class="pl-30"><img class="qr_code_sm" style="background: transparent" src="<?php echo base_url($pay_qrcode) ?>" alt="QR Code"></p>
            <?php endif; ?>
        </div>
    </div>
