...
<div class="card-body p-0">
    ...
    <div class="flex-parent-between bill_area">
        <div class="col-4 py-4 pl-30 pr-30">
			...
			<p style="font-weight: 400; text-transform: uppercase; color: #a7a7a7; margin: 0"><?php echo trans('purchase-from') ?></p>
            <?php else: ?>
			<p style="font-weight: 400; text-transform: uppercase; color: #a7a7a7; margin: 0"><?php echo trans('bill-to') ?></p>
            <?php endif ?>
