...
<div class="card-body p-0">
    ...
    <div class="row p-0 table_area">
        <div class="col-12 table-responsive">
            ...
            <div class="p-30">
                <p style="font-family: opensans; font-size: 12px"><strong>Notes / Terms: </strong></p>
                <p><?php echo $footer_note ?></p>
                 
                <p style="font-family: opensans; text-align: right; font-weight: bold; font-size: 14px">For <?php echo $business_name ?></p>
                <br>
                <br>
                <p style="font-family: opensans; text-align: right; font-weight: bold; font-size: 14px">Authorised Signatory</p>
                <p style="font-family: opensans;">Receiver's Signature _________________________</p>
			</div>
			
            <?php if (!empty($pay_qrcode)): ?>
			<h6 class="pl-10 ml-30" style="font-family: opensans; color: black; font-size: 12px">Scan-QR to Pay</h6>
