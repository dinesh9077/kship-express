<?php
	...
	$bankdetails = $this->admin_model->get_bankdetails(); 
                        ...
                        <div class="col-sm-8">
                           <select class="form-control" name="bank_id" required>
                            ...
                            <?php foreach ($bankdetails as $banking): ?>
                                <option value="<?php echo html_escape($banking->id); ?>" <?php if($banking->id == $payment->bank_id){echo "selected";} ?>>
            ...
            <div class="modal-content modal-md">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label"><?php echo trans('amount') ?></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="amount" value="<?php if(!empty($record_payment)){echo html_escape(0); }else{echo html_escape($invoice->grand_total); } ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label">Select Bank</label>
