                ...
                <tr>
					...
					<td class="bg-mlight" style="padding: 2%; text-align: left">
						<span>
							...
							<?php else: ?>
							<?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php
                ...
                <thead>		
					...
					<tr class="inv-pl30 text-dark">
						...
						<td style="padding: 5px 20px; text-align: right">
							<span class="fs-13"><strong><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo decimal_format($payment->amount/$c_rate,2) ?></strong></span>
						</td>
					</tr>
                    <?php endforeach ?>
                        ...
                        <td style="border-top: 3px solid #dfdede; padding: 5px 20px; text-align: right">
                            <span>
								<strong>
									...
									<?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo $convert_total/$c_rate; ?>
