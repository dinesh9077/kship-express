                ...
                <tbody>
                   ...
                   <?php if($this->business->invoice_tax == 1): ?>
					...
					<tr class="inv-pl30">
						...
						<td></td>
						<td></td>
						<td class="text-right" style=" color: black"><strong><?php echo $tax->tax_type; ?> :</strong></td>
						<td class="text-right" style=" color: black"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo decimal_format($tax->tax_value); ?></span></td>
					</tr>
					<?php endif ?>
        					<?php endforeach ?>
                        <?php endif ?> 
					...
					<?php if ($tax != 0): ?>
						...
						<td></td>
						<td></td>
						<td class="text-right" style=" color: black"><strong><?php echo $key; ?> :</strong></td>
						<td class="text-right" style=" color: black"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo decimal_format($tax); ?></span></td>
					</tr>
					<?php endif ?>
					<?php endforeach ?>
                    <?php endif ?> 
