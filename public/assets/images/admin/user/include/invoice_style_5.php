...
<div class="card-body p-0">
                ...
                <thead class="pre_head2s">
                    <tr class="pre_head_trs">
                        ...
                        <th class="border-0">
							...
							<p class="text-white" style="font-weight: normal"><?php echo html_escape($number) ?></p>
						</th>
                        ...
                        <th class="border-0">
                            ...
                            <p class="text-white" style="font-weight: normal"><?php echo my_date_show($date) ?></p>
						</th>
						...
						<th class="border-0">
							...
							<p class="text-white" style="font-weight: normal">
    ...
    <div class="row p-20 m-0 table_area" style="width: 100%">
        <div class="col-12 table-responsive">
            <table class="table m-0">
                <thead class="pre_head5">
                    <tr class="pre_head_tr5">
                        <th class="border-0" style="color: <?php echo $color; ?>"><?php echo trans('items') ?></th>
                        <th class="border-0" style="color: <?php echo $color; ?>">HSN/SAC Code</th>
                        <th class="border-0 text-right" style="color: <?php echo $color; ?>"><?php echo trans('rate') ?></th>
                        <th class="border-0 text-center" style="color: <?php echo $color; ?>"><?php echo trans('quantity') ?></th>
                        <th class="border-0 text-center" style="color: <?php echo $color; ?>">Unit</th>
                        <th class="border-0 text-right" style="color: <?php echo $color; ?>"><?php echo trans('amount') ?></th>
					</tr>
				</thead>
                <tbody>
					...
					<tr>
						<td width="40%">
							<p class="m-0"><strong><?php echo html_escape($item->item_name) ?></strong></p>
