        ...
        <div class="col-6 py-4 pl-30 pr-30" style="width: 25%; float: left;">
			...
			<p class="mb-0">
				...
				<p class="mt-0 mb-0" style="font-size: 12px; text-transform: uppercase;"><?php echo helper_get_vendor($customer_id)->address ?></p>
				 <p class="mb-0" style="font-size: 12px"><?php echo html_escape(helper_get_customer($customer_id)->country) ?></p>
            ...
            <table class="table">
                ...
                <tbody>
					...
					<tr class="inv-pl30">
						...
						<td style="border-top: 0; padding: 5px 10px"></td>
						<td style="border-top: 0; padding: 5px 10px"></td>
						<td class="text-right" style="border-top: 0; font-weight: bold; font-size: 12px; padding: 5px 10px"><strong><?php echo trans('discount') ?> <?php echo html_escape($discount_percent) ?>% :</strong></td>
						<td class="text-right" style="border-top: 0; font-size: 12px; padding: 5px 20px; text-align: right"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo number_format($discount, 2) ?></span></td>
					</tr>
					<tr class="inv-pl30" style="border-top: 3px solid #dfdede">
                        <td></td>
                        <td></td>
                        ...
                        <td style="font-size: 12px; padding: 5px 20px; text-align: right"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo number_format($sub_total- $discount, 2) ?></span></td>
					</tr>
                    <?php else: ?>
                    <tr class="inv-pl30" style="border-top: 3px solid #dfdede">
                        <td></td>
					...
					<tr class="inv-pl30 text-dark">
						...
						<td class="text-right">
							<span class="fs-13" style="font-size: 12px; padding: 5px 10px; text-align: right"><strong><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo number_format($payment->amount/$c_rate,2) ?></strong></span>
						</td>
					</tr>
                    <?php endforeach ?>
