            ...
            <table class="table m-0" style="border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-left: 0; border-right: 0; margin: 0">
                <thead>
                    <tr>
						...
						?> 
                        <th style="color: black; font-family: opensans; font-weight: bold; padding: 5px 10px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-left: 0" colspan="<?php echo $cols; ?>"><?php echo trans('items') ?></th>
						...
						<?php if($this->business->invoice_tax == 1):?>
						    <?php if (!empty($taxes)): ?>
            					<?php foreach ($taxes as $tax): ?>
                					<?php if ($tax != 0): ?>
                					    <th style="font-family: opensans; font-weight: bold; text-align: center; padding: 5px 10px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px; color:black"><?php echo $tax->tax_type; ?> %</th>
						                <th style="font-family: opensans; font-weight: bold; text-align: center; padding: 5px 10px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px; color:black"><?php echo $tax->tax_type; ?> Amount</th>
                					<?php endif ?>
            					<?php endforeach ?>
            				<?php else: ?>
						    <th style="font-family: opensans; font-weight: bold; text-align: center; padding: 5px 10px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px; color:black">Tax</th>
						    <?php endif ?> 
						<?php endif; ?>
                ...
                <tbody>
					...
					<tr>
						<td colspan="8" style="font-family: opensans; font-weight: bold; text-align: center; padding: 5px 10px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-right: 0"><?php echo trans('empty-items') ?></td>
					</tr>
					<?php else: ?>
					...
					<?php 
						...
						?>
						<tr class="inv">
							<td style="border-top: 0; border-left: 0; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse;" colspan="<?php echo $cols;?>">
								
								<p class="m-0" style="font-family: opensans; font-weight: bold; font-size: 12px;">
							...
							<?php if($this->business->invoice_discount == 1):?>
							<td style="font-family: opensans; border-top: 0; text-align: center;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px"><?php if(!empty($this->session->userdata('discount')[$i])){echo html_escape($this->session->userdata('discount')[$i]).'%';}else{echo "-";} ?></td>
							<?php endif; ?>
							<?php if($this->business->invoice_tax == 1):?>
							...
							<td style="font-family: opensans; border-top: 0; text-align: right; padding-right:20px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-right: 0; font-size: 12px">
								<?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo decimal_format($this->session->userdata('total_price')[$i], 2) ?>
							</td>
						</tr>
						<?php 
					...
					<tr class="inv">
						...
						<?php endif;?>
						<td style="font-family: opensans; border-top: 0; text-align: right; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px;"><p class="m-0"><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo decimal_format($item->price,2) ?></p></td>
						...
						<?php if($this->business->invoice_discount == 1):?>
						<td style="font-family: opensans; border-top: 0; text-align: center; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px;"><?php if(!empty($item->discount)){echo html_escape($item->discount).'%';}else{echo "-";} ?></td>
						<?php endif; ?>
						<?php if($this->business->invoice_tax == 1):?>
    							...
    							<?php 
    							    ...
    							    if(!empty($item->taxs))
    								{
    									...
    									$taxvals = explode(',',$item->taxvals);
    									$totaltaxamt = 0;
    									foreach($taxes as  $key => $tax)
    									{   
    							?>
						                    <td style="font-family: opensans; border-top: 0; text-align: center; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px;"><?php echo $taxs[$key]; ?></td>
						                    <td style="font-family: opensans; border-top: 0; text-align: center; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px;"> <?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo decimal_format($taxvals[$key]); ?> </td>
						                   <?php
    									}
    								}
    								else
    							...
    							?>
						<?php endif; ?>
						<td style="font-family: opensans; border-top: 0; text-align: right; padding-right:20px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-size: 12px; border-right: 0"><p class="m-0"><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?> <?php echo decimal_format($item->total, 2) ?></p></td>
					</tr>
					<?php endforeach ?>
					<?php endif ?>
                    <?php endif ?>
					...
					<?php if($this->business->invoice_discount == 1): ?>
					<tr class="inv">
					    <td style="font-family: opensans; border: 0; text-align: center; border-left: 0"></td>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>
						
						<?php if($this->business->invoice_tax == 1 && count($taxes)==1){ ?>
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
						<?php if($this->business->invoice_tax == 0 && count($taxes)==1){ ?>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>  
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
						<?php if($this->business->invoice_tax == 1 && count($taxes) >= 2){ ?>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>
						<?php } ?>
						...
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
						<td colspan="2" class="text-right border-0" style="font-family: opensans; font-size: 12px; padding: 5px 12px; border: 1px solid <?php echo html_escape($color) ?> !important; border-collapse: collapse; font-weight: bold"><strong>Total :</strong></td>
						<td class="border-0" style="font-family: opensans; font-size: 12px; padding: 5px 20px; text-align: right; border: 1px solid <?php echo html_escape($color) ?> !important; border-collapse: collapse; border-right: 0 !important"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} if (isset($page_title) && $page_title == 'Invoice Preview'){ echo decimal_format($this->session->userdata('sub_total'),2); }else{ echo decimal_format($sub_total,2); } ?></span></td>
					</tr>
					<tr class="inv">
						<td style="font-family: opensans; border: 0; text-align: center; border-left: 0"></td>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>
						...
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
						<td colspan="2" class="text-right border-0" style="font-family: opensans; font-size: 12px; border-top: 0; padding: 5px 12px; border: 1px solid <?php echo html_escape($color) ?> !important;  border-collapse: collapse; font-weight: bold"><strong><?php echo trans('discount') ?> <?php echo html_escape($discount_percent) ?>% :</strong></td>
						<td class="border-0" style="font-family: opensans; font-size: 12px; border-top: 0; padding: 5px 20px; text-align: right; border: 1px solid <?php echo html_escape($color) ?> !important;  border-collapse: collapse; border-right: 0 !important"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} if (isset($page_title) && $page_title == 'Invoice Preview'){ echo decimal_format($this->session->userdata('total_discount') , 2);  }else{   echo decimal_format($discount, 2); } ?></span></td>
					</tr>
					<tr class="inv">
                        <td style="font-family: opensans; border: 0; text-align: center; border-left: 0"></td>
						<td style="font-family: opensans; border: 0; text-align: center;"></td>
						...
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
                        <td colspan="2" style="font-family: opensans; font-size: 12px; padding: 5px 12px; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; text-align: right; font-weight: bold"><strong><?php echo trans('sub-total') ?>:</strong></td>
					...
					<tr class="inv">
						...
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
                        <td colspan="2"  class="text-right" style="font-family: opensans; font-size: 12px; padding: 5px 12px; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-weight: bold"><strong><?php echo trans('sub-total') ?> : </strong></td>
                    ...
                    <?php 
						if (!empty($taxes)):
							...
							foreach ($taxes as $tax):  
								if ($tax != 0):
									$total_tax = $total_tax + $tax->tax_value;
								endif;
							endforeach;
					?>
					<tr class="inv"> 
						...
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
						<td colspan="2" class="text-right" style="font-family: opensans; font-size: 12px; border-top: 0; padding: 5px 12px;  border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-weight: bold"><strong>
							Total Tax :
						</strong></td> 
						<td style="font-family: opensans; font-size: 12px; border-top: 0; padding: 5px 20px; text-align: right; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-right: 0"><span><?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} echo decimal_format($total_tax); ?></span></td>
					</tr>
                    <?php endif ?> 
                    ...
                    <tr class="inv">
						...
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
                        <td colspan="2"  class="text-right" style="font-family: opensans; font-size: 12px; padding: 5px 12px; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; font-weight: bold"><strong><?php echo trans('grand-total') ?>:</strong></td>
					...
					<tr class="inv text-dark">
						...
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
						<td colspan="2"  class="text-right" style="font-family: opensans; font-size: 12px; padding: 5px 12px; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse;">
						...
						<td style="font-family: opensans; font-size: 12px; padding: 5px 20px; text-align: right; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-right: 0">
					...
					<tr class="inv">
						...
						<td style="font-family: opensans; border: 0; text-align: center;"></td> 
						<?php } ?>
                        <td colspan="2" class="text-right" style="font-family: opensans; font-size: 12px; border-top: 3px solid #dfdede; padding: 5px 12px; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-bottom: 1px solid transparent; font-weight: bold"><strong><?php echo trans('amount-due') ?>:</strong></td>
                        <td style="font-family: opensans; font-size: 12px; border-top: 3px solid #dfdede; padding: 5px 20px; font-weight: bold; text-align: right; border: 1px solid <?php echo html_escape($color) ?>; border-collapse: collapse; border-right: 0; border-bottom: 1px solid transparent">
                            <span>
								<strong>
									<?php if ($status == 2): ?>
