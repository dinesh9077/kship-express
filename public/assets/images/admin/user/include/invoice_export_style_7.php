...
<div class="card-body p-0">
    <div class="row align-items-start" style="justify-content: space-between">
        ...
        <div class="st7_toph p-25 col-6 text-right" style="width: 45%; float: right; background: <?php echo html_escape($color) ?>; color: #fff; padding: 25px">
            <h1 class="mb-0" style="color: white; text-transform: uppercase; font-weight: 400"><?php echo html_escape($title) ?></h1>
            <p class="mb-0" style="font-size: 12px; font-weight: bold"><?php echo html_escape($business_name) ?></p>
    ...
    <div class="row align-items-start" style="justify-content: space-between">
        ...
        <div class="col-5 py-4 text-right" style="width: 40%; float: right; text-align: right;">
            ...
            <table class="table">
                ...
                <tbody>
					...
					<tr class="inv-pl30">
						...
						<td style="border-top: 0; font-size: 12px"><p><?php echo $item->hsn_sac ?></p></td>
                    ...
                    <tr class="inv-pl30">
                        ...
                        <td style="border-top: 0; padding: 5px 10px"></td>
                        <td style="border-top: 0; padding: 5px 10px"></td>
                        <td class="text-right" style="background: <?php echo html_escape($color) ?>0f; color: white; font-weight: bold; font-size: 12px; padding: 5px 10px"><strong><?php echo trans('amount-due') ?>:</strong></td>
                        <td class="text-right" style="background: <?php echo html_escape($color) ?>0f; color: white; font-size: 12px; padding: 5px 20px; text-align: right">
                            <span>
                                <?php if ($status == 2): ?>
								<?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?>0.00 
                                <?php else: ?>
