...
<div class="card-body p-0">
    ...
    <div class="row p-35 align-items-start" style="justify-content: space-between">
        <div class="col-3" style="width: 35%; float: left;">
            <h1 class="mb-1" style="text-transform: uppercase; font-weight: 400"><?php echo html_escape($title) ?></h1>
    ...
    <div class="row p-35 align-items-start" style="justify-content: space-between">
        <div class="col-3" style="width: 35%; float: left;">
            ...
            <p style="font-size: 14px"><?php echo html_escape($country) ?></p>
        ...
        <div class="col-5 text-right" style="width: 40%; float: right;">
            
            <?php if (isset($page) && $page == 'Bill'): ?>
			<h5 class="mb-0" style="font-weight: 400; text-transform: uppercase; font-size: 14px"><?php echo trans('purchase-from') ?></h5>
            <?php else: ?>
			<h5 class="mb-0" style="font-weight: 400; text-transform: uppercase; font-size: 14px"><?php echo trans('bill-to') ?></h5>
            <?php endif ?>
    ...
    <div class="row p-35 invinfo_area" style="background: <?php echo html_escape($color) ?>">
            ...
            <table class="table m-10">
                <thead class="pre_head">
                     <tr class="pre_head_tr inv-pl30">
                        <th class="border-0" style="font-weight: bold; color:<?php echo html_escape($color) ?>; font-size: 12px"><?php echo trans('items') ?></th>
						<th class="border-0" style="font-weight: bold; color:<?php echo html_escape($color) ?>; font-size: 12px">HSN/SAC Code</th>
                        <th class="border-0" style="font-weight: bold; color:<?php echo html_escape($color) ?>; font-size: 12px; text-align: center;"><?php echo trans('rate') ?></th>
                        <th class="border-0" style="font-weight: bold; color:<?php echo html_escape($color) ?>; font-size: 12px; text-align: center;"><?php echo trans('quantity') ?></th>
						<th class="border-0" style="font-weight: bold; color:<?php echo html_escape($color) ?>; font-size: 12px; text-align: center;">Unit</th>
                        <th class="border-0" style="font-weight: bold; color:<?php echo html_escape($color) ?>; font-size: 12px; text-align: center;"><?php echo trans('amount') ?></th>
					</tr>
				</thead>
                <tbody>
