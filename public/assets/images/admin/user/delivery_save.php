    ...
    <section class="content">
        <div class="container">
            <div class="col-md-10 m-auto">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2 class="mt-0">Delivery #<?php echo html_escape($invoice->number) ?></h2>
                        <p><?php echo trans('created') ?>: <?php echo my_date_show($invoice->created_at); ?></p>
                    </div>

                    <div class="col-md-8 text-right">
                        <a href="<?php echo base_url('admin/delivery/edit/'.md5($invoice->id)) ?>" class="btn btn-default btn-rounded mr-5"><i class="icon-pencil"></i> <?php echo trans('edit') ?> </a>
                        <div class="btn-group mr-5">
                            ...
                            <div class="dropdown-menu st" x-placement="bottom-start">
                                ...
                                <a class="dropdown-item convert_to_invoice" href="<?php echo base_url('admin/delivery/convert/'.md5($invoice->id)) ?>">Convert to delivered</a>
                                ...
                                <a target="_blank" class="dropdown-item" href="<?php echo base_url('readonly/delivery/preview/'.md5($invoice->id)) ?>"><?php echo trans('preview-as-a-customer') ?></a>
                                <a class="dropdown-item delete_item" href="<?php echo base_url('admin/delivery/delete/'.md5($invoice->id)) ?>"><?php echo trans('delete') ?></a>
                            </div>
                        </div>
                        <a href="<?php echo base_url('admin/delivery/create') ?>" class="btn btn-info btn-rounded"><i class="fa fa-plus"></i> New Challan</a>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-zoom modal-md">
        <form id="send-delivery-form" method="post" enctype="multipart/form-data" class="validate-form send-delivery-form" action="<?php echo base_url('admin/delivery/send')?>" role="form" novalidate>
            <div class="modal-content modal-md">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Send Delivery Challan <?php echo html_escape($invoice->id) ?></h4>
