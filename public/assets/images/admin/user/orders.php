...
<div class="content-wrapper">
    <section class="content">
        <div class="">
            <div class="row">
                <div class="col-md-12">
                    <a href="http://localhost/accountieons/admin/invoice/sale_return_list" class="view_link table_view">Overdue</a>
                    ...
                    <form method="GET" class="sort_invoice_form" action="<?php echo base_url('admin/bills') ?>">
                        <div class="row p-15 mt-10 mb-0" style="padding-right: 0 !important;">
                            <div class="col-lg-12 p-0 ">
                                <p class="mb-5"><a href="<?php echo base_url('admin/bills') ?>" class="view_link table_view">Clear Filter</a></p>
                            </div>
                                            ...
                                            <?php else : ?>
                                                <?php foreach ($bills as $bill) :
                                                    ...
                                                    <tr id="row_<?php echo html_escape($bill->id) ?>">
                                                        ...
                                                        <td><a href="<?php echo base_url('admin/bills/details/' . md5($bill->id)) ?>" class="view_link table_view"><?php echo my_date_show($bill->date); ?></a></td>
                                                        <td><a href="<?php echo base_url('admin/bills/details/' . md5($bill->id)) ?>" class="view_link table_view"> <?php echo ($bill->prefix) ? $bill->prefix . ' - ' : ''; ?><?php echo html_escape($bill->number) ?></a></td>
                                                        <td style="text-transform: capitalize">
                                                            <?php if (!empty(helper_get_vendor($bill->customer))) : ?>
                                                                <a href="<?php echo base_url('admin/bills/details/' . md5($bill->id)) ?>" class="view_link table_view">
...
<?php foreach ($bills as $bill) : ?>
    ...
    <div id="recordPayment_<?php echo html_escape($bill->id) ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="vcenter" aria-hidden="true">
        <div class="modal-dialog modal-dialog-zoom modal-md">
            <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/bills/new_record_payment') ?>" role="form" novalidate>
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <?php
                                $due_amt = ($bill->grand_total - get_total_invoice_payments($bill->id, $bill->parent_id));
                            ?>
                            <div class="col-sm-8">
                    			<input class="form-control amount" placeholder="amount" type="text" name="amount" value="<?php echo $due_amt; ?>" min="0" id="amount_<?php echo $i; ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" max='<?php echo $due_amt; ?>' required>
                            </div>
                        </div>
                        <div class="form-group row">
