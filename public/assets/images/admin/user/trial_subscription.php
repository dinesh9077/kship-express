										...
										<tbody>
											<tr>
												...
												<td class="text-center">
													<h2 class="mt-10"><?php if($package->is_special == 1): ?><label class="popular-pkg">MOST POPULAR </label><?php endif ?><br><?php echo html_escape($package->name); ?> 
													</h2>
...
<?php 
	if($this->session->userdata('start_pixel') == 'start_trial') 
	{
	?>
	<!-- Facebook Pixel Code -->
	<script>
	...
	<noscript>
		...
		src="https://www.facebook.com/tr?id=631435904807252&ev=PageView
		&noscript=1"/>
	</noscript>
	...
	<?php 
		$this->session->unset_userdata('start_pixel');
	}
	?>	