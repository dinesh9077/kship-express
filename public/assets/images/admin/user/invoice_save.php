										...
										<div class="m-l-10 align-self-center" style="width: 100%">
											...
											<div class="payment_record flex-parent-between" id="row_<?php echo html_escape($payment->id) ?>">
												<p>
													...
													<strong class="text_mark">
														<?php 
															if (!empty($this->business->currency_symbol)) 
															{
																echo html_escape($this->business->currency_symbol);
															}
															if ($convert_total != 0) {
																echo decimal_format($payment->amount / $invoice->c_rate, 2);
																} else {
																echo decimal_format($payment->amount, 2);
															}
														?>
												</strong> at <strong class="text_mark"><?php echo my_date_show($payment->payment_date) ?></strong> <?php echo trans('using') ?> <strong class="text_mark"><?php echo get_using_methods($payment->payment_method) ?></strong></span>
											</p>
