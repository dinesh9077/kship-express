    ...
    <div class="content-wrappers">
        <section class="content p-0">
            ...
            <div class="readonly-title">
                <h2>Challan <?php echo html_escape($invoice->number) ?> <?php echo trans('from') ?> - <?php echo html_escape($invoice->business_name) ?></h2>
            </div>

            <div class="readonly-top-bar">
                Challan <?php echo html_escape($invoice->number) ?> <i class="fa fa-circle"></i>
