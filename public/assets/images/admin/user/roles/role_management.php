      ...
      <div class="row bus_area">
        ...
        <div class="col-xl-9">
          ...
          <div class="box add_area" style="display: <?php if ($page_title == "Edit") {
            ...
            <div class="box-header with-border d-flex justify-content-between align-items-center f-no">
              <?php if (isset($page_title) && $page_title == "Edit") : ?>
                <h3><?php echo trans('edit') ?></h3>
              <?php else : ?>
                <h3> <?php echo trans('add-new-user') ?> </h3>
              <?php endif; ?>

              <!-- <div class="box-tools pull-right"> -->
              <?php if (isset($page_title) && $page_title == "Edit") : ?>
                <a href="<?php echo base_url('admin/role_management') ?>" class="pull-right btn btn-info rounded btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a>
              <?php else : ?>
                ...
                <div class="row">
                  <div class="col-md-6 mr-auto">
                    ...
                    <div class="form-group">
                      ...
                      <select class="selectfield textfield--grey form-control col-sm-12 single_select" name="position" required style="width: 100%">
                        <?php $p = 1;
                        foreach (get_business_position() as $position) : ?>
                          <option value="<?php echo html_escape($p); ?>" <?php if ($user[0]['position'] == $p) {
                                                                            echo "selected";
                                                                          } ?>>
                    ...
                    <div class="form-group">
                      ...
                      <input type="radio" id="md_radio_1" class="filled-in chk-col-blue user_role" value="subadmin" name="role" <?php if ($user[0]['role'] == 'subadmin') {
                                                                                                                                  echo "checked";
                                                                                                                                } ?>>
                      <label for="md_radio_1"> <?php echo trans('admin') ?></label><br>

                      <input type="radio" id="md_radio_2" class="filled-in chk-col-blue user_role" value="editor" name="role" <?php if ($user[0]['role'] == 'editor') {
                                                                                                                                echo "checked";
                                                                                                                              } ?>>
                      <label for="md_radio_2"> <?php echo trans('editor') ?></label><br>

                      <input type="radio" id="md_radio_3" class="filled-in chk-col-blue user_role" value="viewer" name="role" <?php if ($user[0]['role'] == 'viewer') {
                                                                                                                                echo "checked";
                                                                                                                              } ?>>
          ...
          <?php if (isset($page_title) && $page_title != "Edit") : ?>
            <div class="list_area container">
              ...
              <?php if (isset($page_title) && $page_title == "Edit") : ?>
                <h3><?php echo trans('edit') ?> <a href="<?php echo base_url('admin/role_management') ?>" class="pull-right btn btn-primary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a></h3>
              <?php else : ?>
                <h3><?php echo $this->business->name ?> <?php echo trans('users') ?>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 scroll table-responsive mt-20 p-0">
                <table class="table table-hover cushover <?php if (count($users) > 10) {
                                                            echo "datatable";
                                                          } ?>" id="dg_table">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <?php if (auth('role') != 'user') : ?>
                      <tr>
                        <td></td>
                        <td>
                          <h3 class="mt-0 mb-0" style="text-transform: capitalize"><?php echo get_by_id($this->business->user_id, 'users')->name; ?></h3>
                        </td>
                    ...
                    foreach ($users as $user) : ?>
                      <tr id="row_<?php echo html_escape($user->id); ?>">
                        ...
                        <td>
                          <h3 class="mt-0 mb-0" style="text-transform: capitalize"><?php echo html_escape($user->name); ?></h3>
                        ...
                        <td>
                          <h4 class="mb-0" style="text-transform: capitalize"><?php echo get_role_name($user->role); ?></h4>
