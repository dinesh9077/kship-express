...
<div class="content-wrapper">
    <section class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="font-size: 26px"><i class="flaticon-approve-invoice"></i>&nbsp;<?php echo trans('invoices') ?>
                        <?php if (check_payment_status() == TRUE || settings()->enable_paypal == 0 || user()->user_type == 'trial') : ?>
                            <div class="add-btn"><a href="<?php echo base_url('admin/invoice/create') ?>" class="btn btn-info btn-rounded"><i class="fa fa-plus"></i> <?php echo trans('create-new-invoices') ?></a></div>
                        <?php endif; ?>
                    </h2>
                    ...
                    <div class="due_amt">
                        <div class="box-body">
                            <p>Overdue</p>
                            <p class="due_amt_title"><?php echo $this->business->currency_symbol . '' . decimal_format($sum, 2)  ?> <span class="text-muted"><?php echo user()->currency_code ?></span></p>
                        </div>
                    </div>
                    ...
                    <form method="GET" class="sort_invoice_form" action="<?php echo base_url('admin/invoice/type/3') ?>">
                        ...
                        <div class="row p-15 mt-20 mb-20">
                            <div class="col-lg-12 p-0 ">
                                <p class="mb-5"><a href="<?php echo base_url('admin/invoice/type/1') ?>" class="view_link">Clear Filter</a></p>
                            </div>
                    ...
                    <ul class="nav nav-tabs custab mt-4" role="tablist">
                        <li class="nav-item"> <a class="nav-link <?php if ($status == 1) {
                                                                        echo "active";
                                                                    } ?>" href="<?php echo base_url('admin/invoice/type/1') ?>" role="tab" aria-selected="true"> <span class="hidden-xs-downs"><?php echo trans('unpaid') ?> <span class="label-count"><?php echo helper_count_invoices($istatus = 1, $type = 1) ?></span></span></a> </li>
                        <li class="nav-item"> <a class="nav-link <?php if ($status == 0) {
                                                                        echo "active";
                                                                    } ?>" href="<?php echo base_url('admin/invoice/type/0') ?>" role="tab" aria-selected="false"> <span class="hidden-xs-downs"><?php echo trans('draft') ?> <span class="label-count"><?php echo helper_count_invoices($istatus = 0, $type = 1) ?></span></span></a> </li>
                        <li class="nav-item"> <a class="nav-link <?php if ($status == 3 && empty($_GET['recurring'])) {
                                                                        echo "active";
                                                                    } ?>" href="<?php echo base_url('admin/invoice/type/3') ?>" role="tab" aria-selected="false"> <span class="hidden-xs-downs"><?php echo trans('all-invoices') ?> <span class="label-count"><?php echo helper_count_invoices($istatus = 3, $type = 1) ?></span></span></a> </li>
                        <li class="nav-item"> <a class="nav-link <?php if (isset($_GET['recurring']) && $_GET['recurring'] == 1) {
                                                                        echo "active";
                                                                    } ?>" href="<?php echo base_url('admin/invoice/type/3?recurring=1') ?>" role="tab" aria-selected="false"> <span class="hidden-xs-downs"><?php echo trans('recurring-invoice') ?> <span class="label-count"><?php echo count_recurring_invoices() ?></span></span></a> </li>
                    </ul>
                                ...
                                <table class="table table-hover cushover">
                                    ...
                                    <tbody>
                                        <?php if (empty($invoices)) : ?>
                                            <tr>
                                                <td colspan="7" class="text-center p-30"><strong>No Data Found</strong></td>
                                            </tr>
                                        <?php else : ?>
                                            <?php $total = 0;
                                            $r = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr id="row_<?php echo html_escape($invoice->id) ?>">
                                                    ...
                                                    <td><a href="<?php echo base_url('admin/invoice/details/' . md5($invoice->id)) ?>" class="view_link"><?php echo my_date_show($invoice->date); ?></td>
                                                    <td>
                                                        <p class="mb-0">
                                                        ...
                                                        <td class="text-right">
                                                            <span class="total-price">
                                                                <a href="<?php echo base_url('admin/invoice/details/' . md5($invoice->id)) ?>" class="view_link">
                                                                    ...
                                                                    } ?> <?php echo decimal_format(html_escape($invoice->grand_total), 2)  ?> <?php if (!empty($currency_code)) {
                                                        ...
                                                        <td class="text-right">
                                                            <span class="total-price">
                                                                <a href="<?php echo base_url('admin/invoice/details/' . md5($invoice->id)) ?>" class="view_link">
                                                                    <?php if (!empty($currency_symbol)) {
                                                                        echo html_escape($currency_symbol);
                                                                    }  ?><?php $due_amt = $invoice->convert_total - get_total_invoice_payments($invoice->id, $invoice->parent_id);
                                                                            echo ($due_amt > 0) ? decimal_format($due_amt / $invoice->c_rate, 2) : '0.00'; ?>
                                                                </a>
                                                            </span>
                                                            <br>
                                                            <span class="conver-total"> <?php echo $this->business->currency_symbol . '' . decimal_format(html_escape($due_amt = $invoice->convert_total - get_total_invoice_payments($invoice->id, $invoice->parent_id)), 2); ?> </span>
                                                        </td>
                                                    <?php else : ?>
                                                        <td class="text-right">
                                                            <span class="total-price">
                                                            ...
                                                            <span class="total-price">
                                                                <a href="<?php echo base_url('admin/invoice/details/' . md5($invoice->id)) ?>" class="view_link">
                                                                    <?php if (!empty($currency_symbol)) {
                                                                        ...
                                                                        $due_amt = $invoice->convert_total - get_total_invoice_payments($invoice->id, $invoice->parent_id);
                                                                        echo decimal_format($due_amt / $invoice->c_rate, 2); ?>
                                                                </a>
                                                            </span>
                                                            <br>
                                                            <?php if ($invoice->status != 1) : ?>

                                                                <span class="conver-total"><?php echo $this->business->currency_symbol . '' . $invoice->convert_total ?></span>
                                                            <?php endif ?>
                                                        </td>
                                                    <?php endif ?>
                                                    ...
                                                    <td class="text-right">
                                                        <?php if ($invoice->status == 2) : ?>
                                                            <?php if ($invoice->type != 4) : ?>
                                                                <a target="_blank" class="mr-5 hide_viewer view_link" href="<?php echo base_url('admin/invoice/details/' . md5($invoice->id)) ?>"><strong><?php echo trans('view') ?></strong></a>
                                                            <?php endif; ?>
                                                        <?php elseif ($invoice->status == 0) : ?>
                                                            <a class="mr-5 approve_item hide_viewer view_link" href="<?php echo base_url('admin/invoice/approve_invoice/' . md5($invoice->id)) ?>"><strong><?php echo trans('approve') ?></strong></a>
                                                        <?php else : ?>
                                                            <a class="mr-5 hide_viewer view_link" href="#recordPayment_<?php echo html_escape($invoice->id) ?>" data-toggle="modal"><strong><?php echo trans('record-a-payment') ?></strong></a>
                                                        <?php endif ?>
                ...
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="amount" value="<?php echo html_escape($invoice->convert_total = $invoice->convert_total - get_total_invoice_payments($invoice->id, $invoice->parent_id)) ?>" required>
                            </div>
                        </div>
