	...
	<section class="content">
		<div class="">
			<div class="col-md-12 m-auto">
				...
				<div class="row mb-10">
					<div class="col-md-12">
						<h2><i class="flaticon-approve-invoice"></i>&nbsp;<?php if (isset($page_title) && $page_title == 'Edit Delivery') {
																				echo "Edit";
																			} else {
																				echo 'Create New Challan';
																			} ?>
							<?php if (isset($page_title) && $page_title == 'Edit Delivery') : ?>
								<a href="<?php echo base_url('admin/delivery/details/' . md5($invoice[0]['id'])) ?>" class="btn btn-default btn-rounded pull-right"><i class="fa fa-long-arrow-left"></i> <?php echo trans('back') ?></a>
							<?php else : ?>
								<a href="<?php echo base_url('admin/delivery') ?>" class="btn btn-default btn-rounded pull-right"> All Challans</a>
							<?php endif ?>
						</h2>
					</div>
				</div>

				<form id="challan_form" method="post" enctype="multipart/form-data" class="validate-form leave_con" action="<?php echo base_url('admin/delivery/add') ?>" role="form" novalidate>
										...
										<div class="panel-body inv">
											<div class="row">
												...
												<div class="col-md-6">
													...
													<?php else : ?>
														<input type="text" class="form-control text-right" name="title" placeholder="<?php echo trans('estimate-title') ?>" value="Delivery Challan">
													<?php endif ?>
													<input type="text" id="example-input-large" name="summary" class="form-control form-control-md text-right" placeholder="Summary example: project name, description of challan" value="<?php echo html_escape($invoice[0]['summary']) ?>"> <br>
												...
												<div class="col-xs-6 col-md-8 text-right">
													<?php if ($this->business->invoice_number == 1) : ?>
														<div class="form-group row">
															<label for="inputEmail3" class="col-sm-8 text-right control-label col-form-label">Challan Number - <?php
																																								if (!empty($this->business->delivery_invoice_prefix)) {
																																									echo $this->business->delivery_invoice_prefix;
																																								}
																																								?></label>
															<div class="col-sm-4">
																<?php if (isset($page_title) && $page_title == 'Edit Delivery') : ?>
																...
																<?php else : ?>
																	<input type="text" class="form-control" name="number" value="<?php echo get_auto_invoice_number(4, 0) ?>">
																<?php endif ?>
															</div>
														</div>
													<?php endif; ?>
													...
													<?php endif; ?>
													<div class="form-group row">
														<label for="inputEmail3" class="col-sm-8 text-right control-label col-form-label">Delivery Date</label>
														<div class="col-sm-4">
													...
													<?php if ($this->business->time_on_invoice == 1) : ?>
														<div class="form-group row d-none">
															<label for="inputEmail3" class="col-sm-8 text-right control-label col-form-label">Time</label>
															<div class="col-sm-4">
																<div class="input-group">
										...
										<div class="col-md-12 p-0">
											<div class="table-responsive">
												<table class="table m-0">
													...
													<tbody>
														<input type="hidden" id="total_item" value="<?php echo (isset($page_title) && $page_title == 'Edit Delivery') ? count(helper_get_invoice_items($invoice[0]['id'])) + 1 : 1; ?>">
					...
					<div class="row mb-20">
						<div class="col-md-12 text-right p-20">
							<button type="submit" class="btn btn-info btn-rounded save_estimate_btn"><i class="fa fa-check"></i> <?php if (isset($page_title) && $page_title == 'Edit Delivery') {
																																		echo "Update";
																																	} else {
																																		echo "Save Challan";
																																	} ?></button>
