		...
		<div class="col-md-6 m-auto box add_area mt-50" style="display: <?php if($page_title == "Edit"){echo "block";}else{echo "none";} ?>">
			<div class="box-header with-border">
				...
				<div class="box-tools pull-right">
					<?php if (isset($page_title) && $page_title == "Edit"): ?>
					<a href="<?php echo base_url('admin/ticket/category') ?>" class="pull-rightrounded  btn btn-default btn-sm"><i class="fa fa-angle-left"></i> Back</a>
					<?php else: ?>
			...
			<div class="box-body">
				<form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/ticket/add')?>" role="form" novalidate>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" required name="name" value="<?php echo html_escape($category[0]['cat_name']); ?>" >
					</div>
					
					<div class="form-group">
						<label><?php echo trans('description') ?> </label>
						<textarea type="text" class="form-control" name="content"><?php echo html_escape($category[0]['content']); ?></textarea>
					</div>
					...
					<div class="form-group">
						...
						<select class="form-control" name="status">
							...
							<option value="0" <?php echo ($category[0]['status'] == 0)?"selected":""; ?>>In-Active</option>
						</select>
					</div>
