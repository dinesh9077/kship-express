				...
				<table class="table table-hover cushover <?php if(count($categories) > 10){echo "datatable";} ?>" id="dg_table">
					...
					<tbody>
						...
						<tr id="row_<?php echo html_escape($cat->id); ?>">
							...
							<td><?php echo $i; ?></td>
							<td style="text-transform: capitalize;"><?php echo html_escape($cat->subcat_name); ?></td>
							<td style="text-transform: capitalize;"><?php echo html_escape($cat->subcat_name); ?></td>
							<?php if($cat->status == "1"){ ?>
							...
							<td class="actions" width="15%">
								<a href="<?php echo base_url('admin/ticket/edit_sub_category/'.html_escape($cat->id));?>" class="on-default edit-row" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> &nbsp; 
								
								<a data-val="Category" data-id="<?php echo html_escape($cat->id); ?>" href="<?php echo base_url('admin/ticket/delete_sub_category/'.html_escape($cat->id));?>" class="on-default remove-row delete_item" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
