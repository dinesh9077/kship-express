...
<body>
    ...
    <div class="main-box">
        ...
        <?php if (isset($page_title) && $page_title != 'Export') : ?>
            <!--  <a href="<?php //echo base_url('readonly/export_invoice/'.$user->puid) 
        ...
        <div class="invoice-box print_area p-0 <?php if (isset($page_title) && $page_title != 'Export') {
            ...
            <table cellpadding="0" cellspacing="0">
                    ...
                    <td colspan="3">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <strong style="font-weight: bold; text-transform: capitalize"><?php echo html_escape($user->user_name) ?></strong><br>
                ...
                <tr class="item">
                    ...
                    <td><?php echo currency_to_symbol(settings()->currency); ?><?php echo html_escape(decimal_format($user->amount)) ?></td>
                    <td style="text-align: right"><?php echo currency_to_symbol(settings()->currency); ?><?php echo html_escape(decimal_format($user->amount)) ?></td>
                </tr>
                <tr class="item">
                    <td></td>
                    <td style="text-align: right"><strong><?php echo trans('sub-total') ?></strong></td>
                    <td style="text-align: right"><span><strong><?php echo currency_to_symbol(settings()->currency); ?><?php echo html_escape(decimal_format($user->amount)) ?></strong></span></td>
                </tr>
