...
<input type="hidden" class="quantity_limit" value="<?php echo $this->business->quantity_limit; ?>">
<input type="hidden" class="amount_decimal" value="<?php echo $this->business->amount_decimal; ?>">
