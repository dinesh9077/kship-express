    ...
    <section class="content"> 
                ...
                <div class="card counts">
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="ml-20 align-self-center">
                                <h2 class="m-b-0"><?php echo number_format($trial_users, 0) ?></h2>
							<h4 class="text-muteds m-b-0">Trial Users</h4></div>
						</div>
					</div>
				</div>
			</div>
        ...
        <div class="row mt-20">
            <div class="col-md-6">
                    ...
                    <div class="box-body p-0">
                        <div class="media-list media-list-hover media-list-divided">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body" style="line-height: 27px;">
                                    <p>
                                        <a class="hover-primary" href="#" style="text-transform: capitalize"><strong><?php echo html_escape($user->name) ?></strong></a>
                                    ...
                                    <span class="label label-default"><?php echo (!empty($user->package_name))?html_escape($user->package_name):"Trial"; ?></span>
									
                                    <?php $payment_status = get_user_payment($user->id) ?>
                                    <?php $label = ''; ?>
                                    <?php if ($payment_status == 'expired'){
                                        $label = 'danger';
                            ...
                            <div class="text-center bt-1 border-light p-2">
                                <a class="text-uppercase d-block font-size-12" href="<?php echo base_url('admin/users') ?>">View all Users <i class="fa fa-long-arrow-right"></i></a>
							</div>
                            <?php endif ?>
						</div>
					</div>
				...
				<div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Recently login user</h3>
					</div>
                    <div class="box-bodyp-0">
                        <div class="media-list media-list-hover media-list-divided">
							<div class="col-md-12 col-sm-12 col-xs-12 scroll table-responsive">
								<table class="table table-hover">
									...
									<tbody>
										<?php 
											$i=1;
											foreach($recently_logins as $rcnt_log): ?>
										<tr>
											<td><?php echo $i; ?></td>
											<td style="text-transform: capitalize"><?php echo $rcnt_log->name; ?></td>
											<td><?php echo $rcnt_log->email; ?></td>
											<td><?php echo $rcnt_log->ip_address; ?></td>
											<td><?php echo $rcnt_log->created_at; ?></td>
										</tr>
										<?php 
											$i++;
											endforeach
							...
							<!--<div class="text-center bt-1 border-light p-2"> 
                                <a class="text-uppercase d-block font-size-12" href="<?php echo base_url('admin/user/login') ?>">See All Login <i class="fa fa-long-arrow-right"></i></a>
							</div>-->
						</div>
					</div>
				</div>
				...
				<div class="col-md-6"> 
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="row br1">
                                    <?php foreach ($user_acts as $user_act): ?>
                                    <div class="dash-package">
                                        <h5 class="mb-0"><?php echo html_escape($user_act->name) ?></h5>
                                        <p class="mt-0"><strong><?php echo html_escape($user_act->total) ?></strong>  </p>
									</div>
                                    <?php endforeach ?>
								</div>
							</div>
